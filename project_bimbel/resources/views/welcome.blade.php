...
<head>
    ...
    <title>Bimbel by Yohanes Wijaya</title>
</head>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="#">Service Account</a>
                    </li>
                </ul>
                <div class="d-flex">
                ...
                <div class="col-lg-11 col-12">
                    <div class="row">
                        <div class="col-lg-6 col-12 copywriting">
                            ...
                            <h1 class="header">
                                Yuk Daftar <span class="text-purple">Dan <br> Belajar</span> Sekarang
                            </h1>
                            <p class="support">
                            Raih cita-citamu dengan membangun ilmu pengetahuan <br> dan rasa ingin tahu yang tinggi.
                            </p>
                            <p class="cta">
                                <a href="#" class="btn btn-master btn-primary">
                                    Get Started
            ...
            <div class="row">
                <div class="col-lg-3 col-12">
                    <div class="item-benefit">
                        ...
                        <p class="support">
                        Learn anywhere and anytime to <br> reach your dreams
                        </p>
                    </div>
                </div>
                <div class="col-lg-3 col-12">
                    <div class="item-benefit">
                        ...
                        <p class="support">
                        Bimbel will help you to choose <br> which lesson is right for you
                        </p>
                    </div>
                </div>
                <div class="col-lg-3 col-12">
                ...
                <div class="col-lg-3 col-12">
                    <div class="item-benefit">
                        ...
                        <p class="support">
                        Get your desire to study together <br> with friends
                        </p>
                    </div>
                </div>
            </div>
        ...
        <div class="container">
            <div class="row item-step pb-70">
                ...
                <div class="col-lg-6 col-12 text-left copywriting">
                    ...
                    <p class="support">
                    We really care about the future career of our students <br> so it will be better if you take the right major
                    </p>
                    <p class="mt-5">
                        <a href="#" class="btn btn-master btn-secondary me-3">
                            Learn More
            ...
            <div class="row item-step pb-70">
                <div class="col-lg-6 col-12 text-left copywriting pl-150">
                    ...
                    <p class="support">
                        Each of you will be joining the private group and also <br> consult with their respective teachers
                    </p>
                    <p class="mt-5">
                        <a href="#" class="btn btn-master btn-secondary me-3">
                            View Demo
            ...
            <div class="row item-step">
                ...
                <div class="col-lg-6 col-12 text-left copywriting">
                    ...
                    <p class="support">
                    Mempelajari sbmptn untuk mempersiapkan masuk <br> perguruan tinggi negeri yang diimpikan
                    </p>
                    <p class="mt-5">
                        <a href="#" class="btn btn-master btn-secondary me-3">
                            Showcase
                ...
                <div class="col-lg-10 col-12">
                    ...
                    <div class="row copyright">
                        <div class="col-lg-12 col-12">
                            <p>
                                All Rights Reserved. Copyright Bimbel Study Indonesia.
                            </p>
                        </div>
                    </div>
                </div>
